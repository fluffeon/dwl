...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xe4e3e0ff, 0x5b544cff, 0xda2a47ff },
	[SchemeSel]  = { 0xe4e3e0ff, 0xda2a47ff, 0xecececff },
...
static const char *menucmd[] = { "wmenu-run", "-f", "Terminus Normal 12", "-N", "#5B544C", "-n", "#ECECEC", "-S", "#DA2A47", "-s", "#E4E3E0", "-M", "#DA2A47", "-m", "#E4E3E0", NULL };
...
static const Key keys[] = {
  ...
  { MODKEY,                    XKB_KEY_e,          spawn,          {.v = periwinklemenu} }, 
